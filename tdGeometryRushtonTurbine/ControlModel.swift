...
//
//    init(state: RushtonTurbineRenderState, stateSubject: PassthroughSubject<RushtonTurbineRenderState, Never>) {
//        self.state = state
//
//        self.tankSection = SectionModel(title: "Tank", fields: [
//            floatField(title: "Diameter", input: Float(state.turbine.tankDiameter), outputBlock: {
//                stateSubject.send(state.changeValues(tankDiameter: $0))
//            }),
//            floatField(title: "Height", input: Float(state.turbine.tankHeight), outputBlock: {
//                stateSubject.send(state.changeValues(tankHeight: $0))
//            })
//        ])
//
//        self.shaftSection = SectionModel(title: "Shaft", fields: [
//            floatField(title: "Radius", input: Float(state.turbine.shaft.radius), outputBlock: {
//                stateSubject.send(state.changeValues(shaftRadius: $0))
//            })
//        ])
//
//        self.baffleSection = SectionModel(title: "Baffle", fields: [
//            integerField(title: "Count", input: state.turbine.baffles.numBaffles, outputBlock: {
//                stateSubject.send(state.changeValues(baffleCount: $0))
//            }),
//            floatField(title: "Inner Radius", input: Float(state.turbine.baffles.innerRadius), outputBlock: {
//                stateSubject.send(state.changeValues(baffleInnerRadius: $0))
//            }),
//            floatField(title: "Outer Radius", input: Float(state.turbine.baffles.outerRadius), outputBlock: {
//                stateSubject.send(state.changeValues(baffleOuterRadius: $0))
//            }),
//                floatField(title: "Width", input: Float(state.turbine.baffles.thickness), outputBlock: {
//                stateSubject.send(state.changeValues(baffleWidth: $0))
//            })
//        ])
//
//        self.impellerCountSection = SectionModel(title: "Impeller Count", fields: [
//            integerField(title: "Count", input: state.turbine.numImpellers, outputBlock: {
//                state.turbine.numImpellers = $0
//            })
//        ])
//
//        let array = [ImpellerSectionModel]()
////
////        state.turbine.impeller.forEach { impeller in
////            let hubSection = SectionModel(title: "Hub", fields: [
////                floatField(title: "Radius", input: Float(impeller.value.hub.radius), outputBlock: {
////                    stateSubject.send(state.changeValues(hubRadius: $0))
////                }),
////                floatField(title: "Height", input: Float(impeller.value.hub.height), outputBlock: {
...
//            PlaneInputModel(
//                title: "XY Plane",
//                minValue: Int(Float(state.turbine.tankDiameter) * -0.5),
//                maxValue: Int(Float(state.turbine.tankDiameter) * 0.5),
...
//            PlaneInputModel(
//                title: "XZ Plane",
//                minValue: Int(Float(state.turbine.tankHeight) * -0.5),
//                maxValue: Int(Float(state.turbine.tankHeight) * 0.5),
